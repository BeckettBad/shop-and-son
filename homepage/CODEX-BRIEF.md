...
> **ACTIVE SUB-TASK: (none — K2 done @ c68cfc9 on dev, built green + live data path proven. PAUSED at the K2 verify-gate for operator (catalogue visuals + live refresh). Next per order: K3 → L4 → K4 (verify-gate) → K6 → K5. K0 token live in .env; main-menu is the K6 handle. Wave 3 + K1 already live on main via PR #7.)**
