...
> **ACTIVE SUB-TASK: (none — Wave 3: M2 193e0b8, M3 0e5a442+32d2e21 done & reviewed on dev. L3 BLOCKED: homepage/public/images/fam-tattoo.jpg still missing — STOP-and-flag per brief, no substitute. Awaiting operator: save fam photo, then say go for L3. K1 still unpushed; K2+ still paused on token.)**
