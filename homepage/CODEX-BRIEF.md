...
> **ACTIVE SUB-TASK: (none — K6 3dc8053 done, SETTLED: operator ACCEPTED Option A (2026-07-02) — OBJECTS mirrors the live nav = 4 brands, as shipped; no change. On origin/dev. NEXT (awaiting operator "go" + they must add PUBLIC_ vars to GitHub Actions Variables): K5 — nightly rebuild cron + PUBLIC_ token into the Pages deploy build; touches .github/workflows/deploy.yml (operator-aware). LAST Wave-2 sub-task.)**
