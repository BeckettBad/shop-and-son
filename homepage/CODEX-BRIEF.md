...
> **ACTIVE SUB-TASK: (none — K3 6fa12ec + L4 d9ff640 done & pushed to origin/dev. NEXT: K4 (cart drawer + Storefront Cart API) — the verify-gate the operator hand-checks (full add-to-cart → Shopify checkout). Then K6 → K5. cartCreate proven live in K0.)**
